...
def sum_until_prime_input():
    ...
    while is_prime(number) == False:
        ...
        number = int(input('Enter an integer greater than 1'))
    total = total + number
    print('The sum of the input integer is:', total)
def run_test_next_prime():
    """ Tests the   next_prime    function. """
    # -------------------------------------------------------------------------
    # done: 3. Implement this TEST function.
    #   It TESTS the  next_prime  function defined below.
...
def next_prime(m):
    ...
    """
    # -------------------------------------------------------------------------
    # dome: 4. Implement and test this function.
...
def prime_gap(m):
    ...
    n = 2
    p = 3
    firstprime = next_prime(n)
    nextprime = next_prime(p)
    while nextprime - firstprime < m:
        firstprime = next_prime(n)
        nextprime = next_prime(p)
        if nextprime - firstprime < m:
            n = n + 1
            p = p + 1
        gap = gap + 1
    return n
def run_test_wait_for_sum_of_cubes():
    ...
    print()
    print('TEST STARTED!  Has it ended?')
    actual = wait_for_sum_of_cubes(1500)
    expected = 9
    print('Expected:', expected)
    print('Actual:  ', actual)
    print('TEST ENDED!')
